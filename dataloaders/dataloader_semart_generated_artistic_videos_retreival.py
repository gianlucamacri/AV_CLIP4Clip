...
import logging
from datasets.SemArtVideoArtGen.utils import SemArtVideoArtGen
import torch
...
class SemArt_Generated_Artistic_Videos_DataLoader(Dataset):
    ...
    def __init__(
        ...
        if logger is None:
            logger = logging
        self.logger = logger
        avd = SemArtVideoArtGen(metadata_fn, video_dir)
        ...
        if max_tokens > SemArt_Generated_Artistic_Videos_DataLoader._CLIP_TOKEN_LIMIT:
            ...
            self.max_tokens = SemArt_Generated_Artistic_Videos_DataLoader._CLIP_TOKEN_LIMIT
